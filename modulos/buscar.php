        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content border-0 rounded-4 shadow-lg" style="background: linear-gradient(135deg, #1f2c4c 0%, #3b5680 100%);">
                ...
                <div class="modal-header border-0 px-4 pt-4 text-white">
                    ...
                    <button type="button" class="btn btn-light btn-sm rounded-circle shadow-sm" data-bs-dismiss="modal" aria-label="Cerrar">
    ...
    <div class="modal fade" id="modalEliminar" tabindex="-1" aria-labelledby="modalEliminarLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content border-0 rounded-4 shadow-lg">
                ...
                <!-- Cuerpo -->
                <div class="modal-body px-4 py-3 text-center" style="background-color: #f9f9f9;">
                    <p class="text-muted mb-0">
                        ¿Estás seguro de que deseas eliminar <strong id="itemAEliminarNombre">este registro</strong>?<br>
                ...
                <div class="modal-footer border-0 px-4 pb-4 pt-0" style="background-color: #f9f9f9;">
                    ...
                    <button type="button" class="btn btn-danger rounded-pill px-4" id="confirmarEliminarBtn">
